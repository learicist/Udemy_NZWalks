...
// Dependency Injection to allow the DbContext class to be used throughout the application
builder.Services.AddDbContext<NZWalksDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("NZWalksConnectionString"))
);

// Dependency Injection to allow the Auth DbContext class to be used throughout the application
...
// Allow the ability to serve static files stored to DB
